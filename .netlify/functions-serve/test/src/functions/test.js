...
var require_base = __commonJS({
  "node_modules/openai/dist/base.js"(exports2) {
    "use strict";
    ...
    var BaseAPI = class {
      constructor(configuration2, basePath = exports2.BASE_PATH, axios = axios_1.default) {
...
var require_common2 = __commonJS({
  "node_modules/openai/dist/common.js"(exports2) {
    "use strict";
    ...
    exports2.setApiKeyToObject = function(object, keyParamName, configuration2) {
    ...
    exports2.setBasicAuthToObject = function(object, configuration2) {
    ...
    exports2.setBearerAuthToObject = function(object, configuration2) {
      return __awaiter(this, void 0, void 0, function* () {
    ...
    exports2.setOAuthToObject = function(object, name, scopes, configuration2) {
      return __awaiter(this, void 0, void 0, function* () {
        if (configuration2 && configuration2.accessToken) {
    ...
    exports2.serializeDataIfNeeded = function(value, requestOptions, configuration2) {
    ...
    exports2.createRequestFunction = function(axiosArgs, globalAxios, BASE_PATH, configuration2) {
...
var require_api = __commonJS({
  "node_modules/openai/dist/api.js"(exports2) {
    "use strict";
    var __awaiter = exports2 && exports2.__awaiter || function(thisArg, _arguments, P, generator) {
      function adopt(value) {
        return value instanceof P ? value : new P(function(resolve) {
    ...
    Object.defineProperty(exports2, "__esModule", { value: true });
    exports2.OpenAIApi = exports2.OpenAIApiFactory = exports2.OpenAIApiFp = exports2.OpenAIApiAxiosParamCreator = void 0;
    var axios_1 = require_axios2();
    ...
    exports2.OpenAIApiAxiosParamCreator = function(configuration2) {
      return {
        ...
        createCompletionFromModel: (createCompletionFromModelRequest, options = {}) => __awaiter(this, void 0, void 0, function* () {
          ...
          let headersFromBaseOptions = baseOptions && baseOptions.headers ? baseOptions.headers : {};
          localVarRequestOptions.headers = Object.assign(Object.assign(Object.assign({}, localVarHeaderParameter), headersFromBaseOptions), options.headers);
          localVarRequestOptions.data = common_1.serializeDataIfNeeded(createCompletionFromModelRequest, localVarRequestOptions, configuration2);
          return {
            url: common_1.toPathString(localVarUrlObj),
            options: localVarRequestOptions
          };
    ...
    exports2.OpenAIApiFactory = function(configuration2, basePath, axios) {
    ...
    var OpenAIApi2 = class extends base_1.BaseAPI {
      ...
      createCompletion(engineId, createCompletionRequest, options) {
        return exports2.OpenAIApiFp(this.configuration).createCompletion(engineId, createCompletionRequest, options).then((request) => request(this.axios, this.basePath));
      }
      createCompletionFromModel(createCompletionFromModelRequest, options) {
        return exports2.OpenAIApiFp(this.configuration).createCompletionFromModel(createCompletionFromModelRequest, options).then((request) => request(this.axios, this.basePath));
      }
      createEdit(engineId, createEditRequest, options) {
        return exports2.OpenAIApiFp(this.configuration).createEdit(engineId, createEditRequest, options).then((request) => request(this.axios, this.basePath));
      }
      createEmbedding(engineId, createEmbeddingRequest, options) {
        return exports2.OpenAIApiFp(this.configuration).createEmbedding(engineId, createEmbeddingRequest, options).then((request) => request(this.axios, this.basePath));
      }
      createFile(file, purpose, options) {
...
var require_package = __commonJS({
  "node_modules/openai/package.json"(exports2, module2) {
    module2.exports = {
      name: "openai",
      version: "2.0.5",
...
var require_configuration = __commonJS({
  "node_modules/openai/dist/configuration.js"(exports2) {
    "use strict";
    Object.defineProperty(exports2, "__esModule", { value: true });
...
var require_dist = __commonJS({
  "node_modules/openai/dist/index.js"(exports2) {
    "use strict";
...
// functions/test.js
var import_openai = __toModule(require_dist());
